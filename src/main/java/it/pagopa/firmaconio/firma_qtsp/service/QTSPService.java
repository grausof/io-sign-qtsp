...
public class QTSPService {
        ...
        private static String certFilePath = "https://github.com/pagopa/io-sign-qtsp/raw/feat-pades-pdf/fake_cert.p12";
        ...
        public File downloadCert() throws URISyntaxException, InvalidKeyException, IOException {
                BufferedInputStream in = new BufferedInputStream(new URL(certFilePath).openStream());
